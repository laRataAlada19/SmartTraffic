...
<template>
  <Card class="dark-card w-[450px] mx-auto my-8 p-6">
    <CardHeader>
      ...
      <form>
        <div class="form-grid">
          <div class="form-field">
            ...
            <Input id="email" type="email" placeholder="User Email" v-model="credentials.email" class="form-input" />
            <ErrorMessage :errorMessage="storeError.fieldMessage('email')" />
          </div>

          <div class="form-field">
            <Label for="password" class="form-label">Password:</Label>
            <Input id="password" type="password" placeholder="******" v-model="credentials.password"
              class="form-input" />
