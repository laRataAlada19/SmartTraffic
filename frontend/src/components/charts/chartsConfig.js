export default [
  {name: 'Evolução Temporal do Tráfego',type: 'line',component: 'LineChart',description: 'Mostra a variação do total de veículos ao longo do tempo (por dia, semana ou mês), permitindo análises de tendência em diferentes localidades.'},
  ...
  {name: 'Distribuição de Veículos por Tipo',type: 'pie',component: 'PieChart',description: 'Mostra a proporção de cada tipo de veículo (ligeiros, motociclos, bicicletas, camiões, autocarros) no total de tráfego registado, com possibilidade de filtragem por localidade e período.'},
  {name: 'Evolução de Tipos de Veículos',type: 'bar',component: 'TypeVei',description: 'Mostra como diferentes tipos de veículos variam ao longo do tempo, com possibilidade de filtrar por localização e intervalo temporal.'},
  {name: 'Fluxo de Tráfego por Direção', type: 'bar', component: 'Direction', description: 'Exibe o volume de tráfego dividido pelas direções cardinais (norte, sul, leste, oeste), com filtros por localidade e intervalo de tempo.' },
  {name: 'Heatmap de Tráfego por Hora e Tipo de Veículo',type: 'heatmap',component: 'HeatMap',description: 'Representa a densidade de tráfego ao longo do dia por tipo de veículo, utilizando cores para indicar a intensidade em cada hora.'},
  ...
  {name: 'Distribuição de Tráfego por Hora do Dia',type: 'bar',component: 'HourPic',description: 'Apresenta a quantidade total de veículos por hora, permitindo identificar os períodos de maior movimento (horas de pico).'},
